...
class BigDecimalOperations {
    ...
    static BigDecimal computeSum(List<BigDecimal> bigDecimals){
        return bigDecimals.stream()
                          .reduce(BigDecimal.ZERO, BigDecimal::add);
    }

    static BigDecimal computeAverage(List<BigDecimal> input) {
        return computeSum(input).divide(BigDecimal.valueOf(input.size()), RoundingMode.UP);
    }

    static List<BigDecimal> topTen(List<BigDecimal> input) {
    ...
    static void serializeItems(List<BigDecimal> input, String fileOutput) {
        try{
    ...
    static void deserializeItems(List<BigDecimal> readDecimals, String inputFile) {
        try {
